import {
  ...
  setAttributeNS as _$setAttributeNS,
...
const _tmpl$3 = /* #__PURE__ */ _$template(
...
const template2 = (() => {
  ...
  _$effect(
    (_p$) => {
      const _v$ = state.name;
      const _v$2 = state.width;
      const _v$3 = state.x;
      const _v$4 = state.y;
      const _v$5 = props.stroke;
...
const template8 = (() => {
  ...
  const _el$12 = _el$11.firstChild;
