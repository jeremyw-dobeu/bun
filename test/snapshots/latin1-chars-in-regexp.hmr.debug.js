...
Bun.activate(true);
const hmr = new FastHMR(1430071586, "latin1-chars-in-regexp.js", FastRefresh);
...
${JSON.stringify({ expected, real }, null, 2)}`);
    ...
    if (
      newlinePreserved.length !== 1 ||
      newlinePreserved.charCodeAt(0) !== 10
    ) {
...
let $$hmr_re_utob = hmr.exports.re_utob;
let $$hmr_re_btou = hmr.exports.re_btou;
