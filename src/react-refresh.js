...
const C = "for" in Symbol ? Symbol.for("react.memo") : 60115;
const O = typeof WeakMap === "function" ? WeakMap : Map;
const T = new Map();
const k = new O();
const m = new O();
const M = new O();
...
const c = new Set();
const p = new Set();
const R = typeof WeakMap === "function" ? new WeakMap() : null;
let S = !1;
function _(e) {
      ...
      if (f !== void 0) {
        ...
        if (u !== null) {
          const a =
            ...
            c.has(r);
          const y = i.memoizedState != null && i.memoizedState.element != null;
          !a && y
            ? (c.add(r), p.delete(r))
            : (a && y) ||
              (a && !y
